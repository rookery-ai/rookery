...
- **Data files, not code.** Adding a service = a `providers/<p>.yaml` (auth config) + a
  ...
  **79 providers (~432 actions):** the Google family (Gmail/Drive/Sheets/Docs **+ AdSense/GA4/
...
**The everyday tier** (waves 1–3, 2026-08) opened a second axis alongside the business/SaaS
