...
- **Data files, not code.** Adding a service = a `providers/<p>.yaml` (auth config) + a
  ...
  **92 providers (~479 actions):** the Google family (Gmail/Drive/Sheets/Docs **+ AdSense/GA4/
