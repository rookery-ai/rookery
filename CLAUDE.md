...
- **Data files, not code.** Adding a service = a `providers/<p>.yaml` (auth config) + a
  ...
  **130 providers (~712 actions):** the Google family (Gmail/Drive/Sheets/Docs/Calendar/Tasks
  **+ Slides/Forms/Chat/Contacts**, and AdSense/GA4/Search Console), **YouTube**,
  GitHub, Slack, OpenAI, Notion, Outlook, Teams, Jira, HubSpot,
