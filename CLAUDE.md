...
- **Data files, not code.** Adding a service = a `providers/<p>.yaml` (auth config) + a
  ...
  **120 providers (~574 actions):** the Google family (Gmail/Drive/Sheets/Docs **+ AdSense/GA4/
